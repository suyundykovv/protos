...
const (
	StatisticsService_GetUserOrdersStatistics_FullMethodName = "/statistics.v1.StatisticsService/GetUserOrdersStatistics"
...
type StatisticsServiceClient interface {
	GetUserOrdersStatistics(ctx context.Context, in *GetUserOrdersStatisticsRequest, opts ...grpc.CallOption) (*GetUserOrdersStatisticsResponse, error)
...
func (c *statisticsServiceClient) GetUserOrdersStatistics(ctx context.Context, in *GetUserOrdersStatisticsRequest, opts ...grpc.CallOption) (*GetUserOrdersStatisticsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUserOrdersStatisticsResponse)
...
type StatisticsServiceServer interface {
	GetUserOrdersStatistics(context.Context, *GetUserOrdersStatisticsRequest) (*GetUserOrdersStatisticsResponse, error)
...
func (UnimplementedStatisticsServiceServer) GetUserOrdersStatistics(context.Context, *GetUserOrdersStatisticsRequest) (*GetUserOrdersStatisticsResponse, error) {
...
func _StatisticsService_GetUserOrdersStatistics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserOrdersStatisticsRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatisticsServiceServer).GetUserOrdersStatistics(ctx, req.(*GetUserOrdersStatisticsRequest))
	}
...
var StatisticsService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/statistics/v1/statistics.proto",
}
