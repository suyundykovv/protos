...
const (
	...
	InventoryService_DecreaseStock_FullMethodName = "/inventory.v1.InventoryService/DecreaseStock"
	InventoryService_IncreaseStock_FullMethodName = "/inventory.v1.InventoryService/IncreaseStock"
)
...
type InventoryServiceClient interface {
	...
	IncreaseStock(ctx context.Context, in *IncreaseStockRequest, opts ...grpc.CallOption) (*StockResponse, error)
}
...
func (c *inventoryServiceClient) IncreaseStock(ctx context.Context, in *IncreaseStockRequest, opts ...grpc.CallOption) (*StockResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StockResponse)
...
type InventoryServiceServer interface {
	...
	IncreaseStock(context.Context, *IncreaseStockRequest) (*StockResponse, error)
...
func (UnimplementedInventoryServiceServer) IncreaseStock(context.Context, *IncreaseStockRequest) (*StockResponse, error) {
